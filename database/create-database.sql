...
create table project_yarns (
    ...
    constraint fk_project_yarns_pattern_yarns
        foreign key (pattern_yarn_id) references pattern_yarns(pattern_yarn_id) on delete set null,
...
create table project_tools (
    ...
    constraint fk_project_tools_pattern_tools
        foreign key (pattern_tool_id) references pattern_tools(pattern_tool_id) on delete set null,
